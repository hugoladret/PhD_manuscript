...
\iffalse % Déclaration sur l'honneur pour une thèse en français (inverser les \if pour une thèse en anglais)
    Je soussigné, Hugo J. Ladret, %% Prénom et Nom de l'auteur %%
    déclare par la présente que le travail présenté dans ce manuscrit est mon propre travail, réalisé sous la direction scientifique de Laurent Perrinet et Christian Casanova % Prénom et Nom du directeur de thèse et s’il y a lieu du co-directeur de thèse
    ...
    Fait à Marseille le XX/XX/XXXX
...
\iftrue % Affidavit of Honour for english thesis (invert the \if for an English thesis)
    I, undersigned, Hugo J. Ladret, %% First Name and Surname of the PhD student
    hereby declare that the work presented in this manuscript is my own work, carried out under the scientific supervision of Laurent Perrinet and Christian Casanova %% First Name and Surname of the thesis director and if applicable of the co-thesis director
    ...
    \begin{flushright}\includegraphics[width=120px,height=40px]{logo/signature.png}\end{flushright}% signature
